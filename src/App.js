...
function App() {
  let ca = "2UritR2AXmkjN5HoZjJQ3fZqCR2YtB9DUpzRosh4sD8E";
    ...
    <div className="App">
      ...
      <div className="section1">
        <div className="section1-block">
          ...
          <div className="cabox">
            <p className="caText">CA:<br/> {ca}</p>
          </div>
          <div className="socialBlock">
            <a href="https://t.me/SOLANACHADCOIN" target="_blank" rel="noopener noreferrer"><img className="social" alt="telegram" src={tg} /></a>
            <a href="https://twitter.com/CHADSOLANACOIN" target="_blank" rel="noopener noreferrer"><img className="social" alt="twitter" src={tw} /></a>
            <a href="https://dexscreener.com/solana/2UritR2AXmkjN5HoZjJQ3fZqCR2YtB9DUpzRosh4sD8E" target="_blank" rel="noopener noreferrer"><img className="social" alt="dexscreener" src={dex} /></a>
          </div>
